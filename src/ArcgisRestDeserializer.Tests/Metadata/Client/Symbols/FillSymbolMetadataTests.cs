...
{
    [TestClass]
    public class FillSymbolMetadataTests : SymbolMetadataTestsBase
    {
        [TestMethod]
        public void TestFillSymbolMetadata()
        {
  ...
  ""color"": [115,76,0,255],
    ""outline"": {
     ...
     ""width"": 2
            ...
            var rez = JsonConvert.DeserializeObject<FillSymbol>(data, CreateSettings());
